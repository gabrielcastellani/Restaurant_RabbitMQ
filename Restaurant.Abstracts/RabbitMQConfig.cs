namespace Restaurant.Abstracts
{
    public class RabbitMQConfig
    {
        ...
        public const string Exchange = "restaurant";
        ...
        public const string KitchenRoutingKey = "order.cooking"; // Not used yet
        public const string ReadyRoutingKey = "order.ready";
        public const string DeliveryRoutingKey = "order.delivered"; // Not used yet
    }
}
